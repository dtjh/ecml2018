 ...
 *
 */
public class PHTChangeDetector implements CutPointDetector{
    ...
    public PHTChangeDetector(double detectionThreshold) {
...
*/	return false;
    ...
    {
	// TODO Auto-generated method stub
	return String.format("Detection Threshold %.2f", this.detectionThreshold) ;
    }
