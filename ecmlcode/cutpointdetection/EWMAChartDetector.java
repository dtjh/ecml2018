...
public class EWMAChartDetector implements CutPointDetector
{
    private int minNumInstancesOption;
    ...
    public EWMAChartDetector(double lambda)
    {
	this.minNumInstancesOption = 30;
    ...
    @Override
    public boolean setInput(double prediction)
    {
	...
	m_s = Math.sqrt(m_p * (1.0 - m_p) * lambda
		* (1.0 - Math.pow(1.0 - lambda, 2.0 * m_n)) / (2.0 - lambda));
...
//	this.delay = 0;
	...
	if (m_n > this.minNumInstancesOption && z_t > m_p + L_t * m_s)
	{
