...
public class SEEDChangeDetector implements CutPointDetector
{
    
    protected SEED seed;
    
    public double deltaSEEDOption = 0.05;
    public int blockSizeSEEDOption = 32;
    public double epsilonPrimeSEEDOption = 0.01;
    public double alphaSEEDOption = 0.8;
    public int compressTermSEEDOption = 75;

    public SEEDChangeDetector(double delta)
    {
	this.deltaSEEDOption = delta;
    }
	...
	return seed.setInput(inputValue);
    }
    
    @Override
    public void resetLearning()
    {
	seed = new SEED((double)this.deltaSEEDOption, 
		this.blockSizeSEEDOption, 
		(double) this.epsilonPrimeSEEDOption, 
		(double)this.alphaSEEDOption, 
		this.compressTermSEEDOption);
    }
