 ...
 * @version $Revision: 7 $
 */
public class SequentialDrift2 implements CutPointDetector {

    public SequentialDrift2(double delta, int block)
    {
	this.deltaSeqDrift2Option = delta;
	this.blockSeqDrift2Option = block;
    }
    
    protected SeqDrift2 seqdrift;

    public double deltaSeqDrift2Option = 0.05;
    public int blockSeqDrift2Option = 500;
    ...
    public boolean setInput(double inputValue) {
        ...
        return seqdrift.setInput(inputValue);
    }

    @Override
    public void resetLearning() {
        seqdrift = new SeqDrift2((double) this.deltaSeqDrift2Option,((int) this.blockSeqDrift2Option));
    }
